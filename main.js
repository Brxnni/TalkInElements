...
function generate(){
    ...
    for (word of text){
        ...
        if (solutions.length == 0){
            ...
            // This is a really obnoxious color
        ...
        // If so, Add symbols
            ...
            for (symbol of solutions[0]){
                ...
                // If its an element, capitalize
                if (! ["e", "l", "a", "m", "g"].includes(symbol)){
                ...
                // Add block to its container
                blockContainer.appendChild(block);
            }
        }

        // Create a block that contains nothing
        block = document.createElement("div");
        block.classList.add("block");
        // Add space class
...
function changeLanguage(){
    ...
    let button = document.getElementById("changeLanguage");
    if (useEnglish){ button.innerHTML = "Change language (EN)"; }
